          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return queryInterface.changeColumn('activity', 'type', {
                type: DataTypes.ENUM('login_s', 'login_f', 'logout_s', 'ignoreme_s', 'ignoreme_f', 'help_s', 'help_f', 'link_s', 'link_f', 'account_s', 'account_f')
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return queryInterface.changeColumn('activity', 'type', {
                type: DataTypes.ENUM('login_s', 'login_f', 'logout_s', 'ignoreme_s', 'ignoreme_f', 'help_s', 'help_f')
              });
