...
var Tokel = /*#__PURE__*/function () {
  function Tokel(url) {
    (0, _classCallCheck2["default"])(this, Tokel);
  ...
  (0, _createClass2["default"])(Tokel, [{
    ...
    key: "tokenv2AllBalances",
    value: function tokenv2AllBalances(pubkey) {
      console.log('pubkey');
      console.log(pubkey);
    ...
    key: "tokenv2InfoTokel",
    value: function tokenv2InfoTokel(tokenId) {
